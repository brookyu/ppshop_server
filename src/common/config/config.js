...
// const options = {
//   key: fs.readFileSync('./ssl/2_syc.wemakecrm.com.key'),
//   cert: fs.readFileSync('./ssl/1_syc.wemakecrm.com_bundle.crt')
// };
...
module.exports = {
    ...
    weixin: {
        ...
        notify_url: 'https://syc.wemakecrm.com/api/pay/notify' // 微信支付异步通知
    },
    express: {
        // 已废弃，之后考虑改回来，做成和阿里云的物流查询可以切换，方便大家的使用
        // 免费的，但是顺丰的话，要配合快递鸟的电子面单
        // 快递物流信息查询使用的是快递鸟接口，申请地址：http://www.kdniao.com/ 
        appid: '1701009', // 对应快递鸟用户后台 用户ID
        appkey: '67e847d1-8c84-4704-98cf-a7764bdee68d', // 对应快递鸟用户后台 API key
   ...
   mianexpress:{
    ...
    aliexpress:{
        ...
        appcode: 'fdadf044349e41708fbc9082602563a2' ,// 阿里云后台获取,
		sfLastNo:'4238', // 顺丰寄件人后四位，这个根据自己的寄件人手机设置，如果寄件人是不固定的，那么需要在order_express自己写代码了。
    },
	templateId:{
		// deliveryTemplate:
	}
